    ...
    <>
      <div className="about-me container">
        <div className="fade-in-page">
          <section className="header w-50 vh-100 d-flex flex-column justify-content-center">
            <h1>FRONTEND</h1>
          ...
          <section className="describe w-100 vh-100 d-flex flex-column justify-content-center">
            <h1 className="mb-5">
