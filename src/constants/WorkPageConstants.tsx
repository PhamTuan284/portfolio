...
export const projects: Project[] = [
  {
    ...
    description:
      "A full-stack project management application with real-time updates and team collaboration features.",
  ...
  },
  {
    ...
    description:
      "An e-commerce platform with shopping cart, user authentication, and payment integration.",
